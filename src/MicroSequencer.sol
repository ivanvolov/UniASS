...
contract MicroSequencer is BaseOptionHook, ERC721 {
    using PoolIdLibrary for PoolKey;

    constructor(
        IPoolManager poolManager,
        Id _morphoMarketId
    ) BaseOptionHook(poolManager) ERC721("MicroSequencer", "CALL") {
    ...
    function afterInitialize(
        ...
        return MicroSequencer.afterInitialize.selector;
    }
    ...
    function afterSwap(
        ...
        setTickLast(key.toId(), tick);
        return (MicroSequencer.afterSwap.selector, 0);
    }
