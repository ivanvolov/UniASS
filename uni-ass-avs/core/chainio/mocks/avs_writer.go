...
import (
	...
	contractUniASSTaskManager "github.com/Layr-Labs/incredible-squaring-avs/contracts/bindings/UniASSTaskManager"
...
func (m *MockAvsWriterer) RaiseChallenge(arg0 context.Context, arg1 contractUniASSTaskManager.IUniASSTaskManagerTask, arg2 contractUniASSTaskManager.IUniASSTaskManagerTaskResponse, arg3 contractUniASSTaskManager.IUniASSTaskManagerTaskResponseMetadata, arg4 []contractUniASSTaskManager.BN254G1Point) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendAggregatedResponse(arg0 context.Context, arg1 contractUniASSTaskManager.IUniASSTaskManagerTask, arg2 contractUniASSTaskManager.IUniASSTaskManagerTaskResponse, arg3 contractUniASSTaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendNewTaskNumberToSquare(arg0 context.Context, arg1 *big.Int, arg2 types.QuorumThresholdPercentage, arg3 types.QuorumNums) (contractUniASSTaskManager.IUniASSTaskManagerTask, uint32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendNewTaskNumberToSquare", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(contractUniASSTaskManager.IUniASSTaskManagerTask)
	ret1, _ := ret[1].(uint32)
	ret2, _ := ret[2].(error)
