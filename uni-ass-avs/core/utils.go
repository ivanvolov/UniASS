...
// this hardcodes abi.encode() for cstaskmanager.IUniASSTaskManagerTaskResponse
// unclear why abigen doesn't provide this out of the box...
func AbiEncodeTaskResponse(h *cstaskmanager.IUniASSTaskManagerTaskResponse) ([]byte, error) {

	// The order here has to match the field ordering of cstaskmanager.IUniASSTaskManagerTaskResponse
...
func GetTaskResponseDigest(h *cstaskmanager.IUniASSTaskManagerTaskResponse) ([32]byte, error) {
